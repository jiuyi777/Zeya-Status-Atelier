...
(function(script){
  ...
  function api(name){if(name==='getChatMessages'&&typeof getChatMessages==='function')return getChatMessages;if(name==='setChatMessages'&&typeof setChatMessages==='function')return setChatMessages;if(name==='setLorebookEntries'&&typeof setLorebookEntries==='function')return setLorebookEntries;var sources=[window,window.TavernHelper,topWindow,topWindow.TavernHelper];for(var i=0;i<sources.length;i++){var source=sources[i];if(source&&typeof source[name]==='function')return source[name].bind(source);}return null;}
