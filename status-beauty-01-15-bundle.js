...
function addBundledMobileRuntime(structure, script) {
    ...
    const sizingStyles = `<style>html,body{height:auto!important;min-height:0!important;overflow:hidden!important}@media(max-width:560px){body :is(p,span,strong,small,em,b,li,dt,dd,label,figcaption,[data-capture],[data-value],[data-label]){font-size:max(var(--sta-readable-font,12px),.8rem)!important}}</style>`;
